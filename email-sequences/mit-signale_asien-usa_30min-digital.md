# Master-Sequenz: MIT Signale · ASIEN-USA · 30-MIN DIGITAL  ·  Familie: AUGENHÖHE

> **Variant-Code:** `E1–E10 · MIT · ASIEN-USA · 30D · AUGENHÖHE`
...
> - **CTA:** **30-Min digital**, weicher Dialog-Stil (Interesse nicht vorausgesetzt).
> - **Familie:** AUGENHÖHE (fachlicher Austausch auf Augenhöhe, nicht Outbound-Push).
>
> **Globale Regeln (in jedem Prompt verankert)**
> 1. **Output-Zeichen-Regel:** im fertigen E-Mail-Text KEINE der Zeichen `— – * # +`. Fließtext mit Komma/Punkt/Klammern. Normale Wort-Bindestriche (`30-minute`, `15-minute`) bleiben erlaubt.
...
## EMAIL 1 · MIT · ASIEN-USA · 30D · AUGENHÖHE  (Cold-Open)
...
═══════════════════════════════════════════════════════════
ZEICHEN-REGEL IM OUTPUT (verbindlich): Verwende im fertigen E-Mail-Text KEINES der Zeichen Minuszeichen, Gedankenstrich, Sternchen, Raute, Pluszeichen. Reiner Fließtext mit Komma, Punkt und Klammern. Normale Binde-Striche in Wörtern ("30-minute", "15-minute") sind erlaubt.
═══════════════════════════════════════════════════════════
...
STRIKT VERBOTEN:
- Dem Empfänger seine eigene Rolle, seine Herausforderungen oder sein Arbeitsumfeld erklären ("You know the pattern…", "You know that…", "In your role as … you know…").
- Werbliche Superlative und Marketing-Sprache ("exactly the right ones", "exactly what you need", "the ones you really should be winning").
- Konstruiert wirkende rhetorische Fragen ("The only question is: how many of these cycles run without you?").
...
- {{company}} / {{playbook.product.name}} als möglichen relevanten Gesprächspartner positionieren, nicht als Heilsbringer ("could be relevant here", "would be a possible touchpoint", "this is where we come in").
...
- Vermeide: Smalltalk, weiche Formulierungen ("maybe", "perhaps"), lange Einleitungen.
- Wortzahl: 100-120.
...
═══════════════════════════════════════════════════════════
SPRACHREGEL: Die gesamte E-Mail ist IMMER auf ENGLISCH, durchgehend. Anrede 'Dear Mr. {{last_name}},' / 'Dear Ms. {{last_name}},' / 'Hello {{first_name}},'. Schluss 'Best regards,'.
═══════════════════════════════════════════════════════════
...
3. NIEMALS generische Personalisierung ("I saw that your company is growing"). Immer konkret mit Zahlen, Daten, Projekt- oder Produktnamen.
...
**TECHNISCHE EINORDNUNG — NEUTRAL (1-2 Sätze):** Skizziere die Implikation des Signals NEUTRAL und systembezogen, nicht personenbezogen. Kein "you know", kein erklärender Pain Point. Die Brücke zu {{playbook.product.name}} ergibt sich aus der Sache. Für mehr Information siehe {{organization.website_url}} {{playbook.product.description}}.
...
**CTA — 30-Min digital, dialogorientiert:** Offenes Gesprächsangebot, Interesse nicht vorausgesetzt. Bei C/D darf ein konkreter, niederschwelliger Gedanke vorausgehen, dann der 30-Min-Call. Bei I/S einstufig und weich. Standard: "If this is a relevant topic on your side, I'd welcome a 30-minute call, openly, on whether and where it fits." Der CTA darf das Signal subtil aufgreifen.
...
Such steps shift the requirements on DC-side isolation. Short-circuit strength and thermal validation move earlier into the design process, and component data becomes part of the qualification question rather than procurement.
...
If this is a relevant topic on your side, I'd welcome a 30-minute call, openly, on whether and where it fits.

Best regards,"

---

## EMAIL 2 · MIT · ASIEN-USA · 30D · AUGENHÖHE  (Cold-Open, Variante)
...
**TECHNISCHE EINORDNUNG (1-2 Sätze):** Implikation systembezogen, kein "you know". Brücke zu {{playbook.product.name}} ergibt sich aus der Sache. Siehe {{organization.website_url}} {{playbook.product.description}}.
...
**CTA (30-Min digital, dialogorientiert, DISC-kalibriert):** offen, Interesse nicht vorausgesetzt. Standard: "If this is a relevant topic on your side, I'd welcome a 30-minute call, openly, on whether and where it fits."
...
---
**QUALITÄTS-CHECKLISTE:** ✅ Output ohne verbotene Zeichen? ✅ Englisch durchgehend? ✅ DISC erkennbar? ✅ Erster Satz = Buying Signal, DISC-Typ? ✅ kein Rollen-Erklären? ✅ Einordnung neutral? ✅ Gesprächspartner statt Retter, keine Superlative? ✅ Bei C/D Proof-Point? ✅ CTA = offener 30-Min-Call? ✅ Wortzahl im DISC-Bereich (etwas kürzer als DACH/EU)? Keine Platzhalter/Signatur.

---
EMAIL BEISPIEL (Englisch, C-Profil, 30-Min digital):

"Dear Mr. Tanaka,

with the environmental award in February 2026 and the expansion of drives for e-mobility and intralogistics, ABM Greiffenberger is visibly moving into efficiency-critical systems.

As integration density rises, the efficiency and thermal stability of the magnetic circuits move earlier into the design process and become an engineering question, not just procurement.

At Magnetworld we work exactly at this interface: optimizing the magnetic cores of drive systems. In comparable 4.5-Nm applications the efficiency gain was around 15 percent at a more compact footprint. Whether that fits your current designs is best placed in a technical exchange.
...
## EMAIL 3 · MIT · ASIEN-USA · 30D · AUGENHÖHE  (Follow-up, neuer Aspekt)
...
═══════════════════════════════════════════════════════════
**GRUNDHALTUNG:** fachlicher Austausch auf Augenhöhe. Gerade beim Follow-up zählt Zurückhaltung doppelt, nicht drängend, nicht werblich. STRIKT VERBOTEN: dem Empfänger seine Rolle/Herausforderung erklären; werbliche Superlative ("perfect fit", "innovation leader"); konstruierte Verkaufsfragen; floskelhafte Follow-up-Opener ("Did you get my last email?") als alleinstehender erster Satz. STATTDESSEN: knapp an die erste Mail anknüpfen, NEUEN konkreten fachlichen Aspekt einbringen, nicht denselben Pitch wiederholen; {{playbook.product.name}} als möglicher Gesprächspartner; dialogorientiert.
═══════════════════════════════════════════════════════════

SPRACHREGEL: Die gesamte E-Mail ist IMMER auf ENGLISCH, durchgehend. Anrede 'Dear Mr. {{last_name}},' / 'Dear Ms. {{last_name}},' / 'Hello {{first_name}},'. Schluss 'Best regards,'.
DIE EMAIL SOLL 90-120 WÖRTER HABEN (Follow-up kürzer als Erstmail, knapp, respektvoll; etwas kürzer als DACH/EU).
...
**FOLLOW-UP OPENER (1-2 Sätze):** in EINEM kurzen Satz dezent an die erste Mail anknüpfen, kein plumpes "Did you get my email?". Besser: ein knapper, respektvoller Rückbezug, der sofort einen neuen konkreten fachlichen Anknüpfungspunkt einführt (Detail aus {{lead.company_website_scraped}} / {{lead.linkedin_scraped}}).
...
**CTA (30-Min digital, dialogorientiert):** offenes Gesprächsangebot, Interesse nicht vorausgesetzt. Standard: "If this is a relevant topic on your side, I'd welcome a 30-minute call, openly, on whether and where it fits."
...
---
**QUALITÄTS-CHECKLISTE:** ✅ Output ohne verbotene Zeichen? ✅ Englisch? ✅ Opener knapp, kein "Did you get...?", keine Superlative? ✅ NEUER Aspekt, keine Wiederholung? ✅ kein Rollen-Erklären? ✅ Einordnung neutral? ✅ Gesprächspartner, keine Superlative? ✅ CTA = offener 30-Min-Call? ✅ 90-120 Wörter? Keine Platzhalter/Signatur.

---
EMAIL BEISPIEL (30-Min digital):

"Dear Mr. Fleitmann,

a quick note with a concrete thought on my last message, on the positioning of "magier" and the question of how digital brand management translates into live formats.

When digital brand management meets physical formats, technical feasibility usually decides whether the brand experience stays consistent, from staging to room technology.
...
## EMAIL 4 · MIT · ASIEN-USA · 30D · AUGENHÖHE  (Kurzvariante)
...
═══════════════════════════════════════════════════════════
**GRUNDHALTUNG:** fachlicher Austausch auf Augenhöhe. Da die Mail kurz ist, zählt jeder Satz doppelt. STRIKT VERBOTEN: dem Empfänger seine Rolle erklären ("Many in your league..."); werbliche Übertreibungen ("without lifting a finger"); konstruierte Verkaufsfragen als Hook. STATTDESSEN: Hook = präzise NEUTRALE Beobachtung aus einem Buying Signal; Pain und Value sachlich verschmelzen; {{playbook.product.name}} als Anknüpfungspunkt; dialogorientiert.
═══════════════════════════════════════════════════════════

**DISC ({{lead.disc_profile}}):** D 90-105 (kurze Sätze, Implikation zuerst, Anker frischestes Signal aus {{lead.buying_signals}}); I 95-110 (dialogisch, Bezug {{lead.linkedin_posts}} + Signal); S 90-105 (ruhig, strukturelles Signal + Referenz aus {{playbook.references}}); C 95-110 (sachlich, technisches Signal + Proof-Point aus {{playbook.proof_points}}). Leer → C. Mischprofil 70/30.
...
**PAIN + VALUE (2-3 Sätze):** Implikation des Signals systembezogen an {{playbook.product.name}} knüpfen, NICHT beschreiben, was "many in his league" falsch machen. Basierend auf {{playbook.icps}}, {{playbook.product.name}}, {{playbook.product.description}}, {{organization.website_url}}, {{organization.description}}. Bei C/D ein Proof-Point aus {{playbook.proof_points}}, sachlich. Keine Superlative.

Leerzeile

**CTA (kurz, 30-Min digital, dialogorientiert):** offen, kein vorausgesetztes Interesse. Standard: "If this is relevant: would a 30-minute call in the coming weeks work?"
...
---
**QUALITÄTS-CHECKLISTE:** ✅ Output ohne verbotene Zeichen? ✅ Englisch? ✅ DISC erkennbar, Wortzahl? ✅ Hook = neutrale Beobachtung aus Buying Signal, keine Verkaufsfrage? ✅ kein Rollen-Erklären? ✅ Pain+Value sachlich verschmolzen? ✅ keine Übertreibungen? ✅ Bei C/D Proof-Point? ✅ CTA = kurzer, offener 30-Min-Call? Keine Platzhalter/Signatur.

---
EMAIL BEISPIEL (Englisch, D-Profil, 30-Min digital):

"Dear Mr. Hofmann,

your expansion into Poland in 2024 shows KERN Microtechnik is steadily scaling production capacity.

When capacity grows faster than the pipeline, structured outreach to the right decision-makers becomes the bottleneck, often tied to manual qualification. That is where we come in: qualified first conversations with decision-makers in your target industry, aligned with your capacity planning.

If this is relevant: would a 30-minute call in the coming weeks work?

Best regards,"

---

## EMAIL 5 · MIT · ASIEN-USA · 30D · AUGENHÖHE  (mit P.S.)
...
═══════════════════════════════════════════════════════════
**GRUNDHALTUNG:** fachlicher Austausch auf Augenhöhe. STRIKT VERBOTEN: dem Empfänger seine Rolle erklären; belehrende Branchenpauschalen ("Many special machine builders still rely on..."); werbliche Superlative ("thinks in big leaps"); konstruierte Verkaufsfragen. STATTDESSEN: beobachtend, technische Implikation neutral; {{playbook.product.name}} als möglicher Gesprächspartner; dialogorientiert.
═══════════════════════════════════════════════════════════
...
SPRACHREGEL: Die gesamte E-Mail ist IMMER auf ENGLISCH, durchgehend inkl. P.S. Anrede 'Dear Mr. {{last_name}},' / 'Dear Ms. {{last_name}},' / 'Hello {{first_name}},'. Schluss 'Best regards,'.
...
**SACHLICHE EINORDNUNG (2 Sätze):** Implikation systembezogen, mit Bezug zu {{playbook.product.description}}, keine Branchenpauschalen, kein "you know".
...
**CTA (weich, 30-Min digital):** offen, Interesse nicht vorausgesetzt. Standard: "If this is a relevant topic on your side, I'd welcome a 30-minute call, openly, on whether and where it fits."
...
---
**QUALITÄTS-CHECKLISTE:** ✅ Output ohne verbotene Zeichen? ✅ Englisch (inkl. P.S.)? ✅ DISC erkennbar? ✅ Einstieg = Buying Signal, beobachtend? ✅ kein Rollen-Erklären, keine Branchenpauschalen? ✅ Einordnung neutral? ✅ Gesprächspartner, keine Superlative? ✅ CTA = weicher 30-Min-Call? ✅ P.S. nur D/I/C, sachlich, max. 2 Sätze; KEIN P.S. bei S? Keine Platzhalter/Signatur (außer P.S.-Schluss).

---
EMAIL BEISPIEL (Englisch, C-Profil, mit P.S., 30-Min digital):

"Dear Ms. Brenner,

your new plant in Regensburg and the stated goal of doubling DACH revenue by 2026 point to a clear growth course.

As capacity grows, the focus typically shifts from production to the question of how predictably new industrial customers are won, especially without further tying up the existing sales team.

At amplifa we work exactly on that stretch: target research, personalized first outreach and scheduled first conversations directly in the calendar. In machinery environments the values are typically 8 to 15 qualified new customer conversations per month. Whether that fits your planning is best placed in a direct exchange.

If this is a relevant topic on your side, I'd welcome a 30-minute call, openly, on whether and where it fits.

Best regards,

P.S. A Bavarian machine builder won three new OEM customers within six weeks with this approach, I'd be glad to share the details in a call."

---

## EMAIL 6 · MIT · ASIEN-USA · 30D · AUGENHÖHE  (Follow-up, neuer Blickwinkel)
...
**CTA (30-Min digital, noch niedrigschwelliger als in der ersten Mail):** Standard: "If this is a relevant topic on your side, I'd welcome a 30-minute call, openly, on whether and where it fits."
...
I wrote to you a few days ago, and perhaps the timing was off, which I know well.

Today I wanted to raise a different angle: in CNC environments, sales leaders tell us the issue is not lead volume but quality, contacts that were never truly ready to buy. Our approach at amplifa starts exactly there: through AI-based pre-qualification, only decision-makers with real demand land in the calendar. No cold-call roulette, no wasted sales hours.
...
## EMAIL 7 · MIT · ASIEN-USA · 30D · AUGENHÖHE  (Storytelling)
...
SPRACHREGEL: Die gesamte E-Mail ist IMMER auf ENGLISCH, durchgehend. Anrede 'Dear Mr. {{last_name}},' / 'Dear Ms. {{last_name}},' / 'Hello {{first_name}},'. Schluss 'Best regards,'.
DIE EMAIL SOLL 140-160 WÖRTER HABEN (etwas kürzer als DACH/EU).
...
**CTA (30-Min digital):** Standard: "I'd be glad to show you in a 30-minute call whether a similar approach makes sense for you too."
...
your focus on automated welding systems for the automotive supplier industry shows STROTHMANN operates in a market that demands precise decision-makers.

A special machine builder from the Stuttgart region, similar size, similar target customers, faced exactly this challenge: sales was at capacity, new customers came almost entirely through existing referrals, and there was simply no time for active new business. With our fully automated outbound system we booked 11 qualified first conversations with purchasing and production leads within 8 weeks, without sales having to touch a single contact.

I wonder whether STROTHMANN holds similar potential, the target group is clearly defined and outreach can be scaled precisely.

I'd be glad to show you in a 30-minute call whether a similar approach makes sense for you too.

Best regards,"

---

## EMAIL 8 · MIT · ASIEN-USA · 30D · AUGENHÖHE  (Pattern-Interrupt)
...
SPRACHREGEL: Die gesamte E-Mail ist IMMER auf ENGLISCH, durchgehend. Anrede 'Dear Mr. {{last_name}},' / 'Dear Ms. {{last_name}},' / 'Hello {{first_name}},'. Schluss 'Best regards,'.
DIE EMAIL SOLL 130-150 WÖRTER HABEN (etwas kürzer als DACH/EU).
...
**CTA (30-Min digital, selbstbewusst und klar):** Standard: "If this is on your mind, a 30-minute call is enough to see whether we can help."
...
how many of your sales hours in the last 90 days actually led to a new customer order, and how many drained into contacts that were never truly ready to buy?

REHM Thermal Systems builds soldering systems running in the production lines of the most demanding electronics manufacturers worldwide. But from the outside, new customer acquisition looks like it does at most mid-sized firms: reactive, trade-show dependent, too focused on existing accounts. That is not a reproach, it is the reality in a market where sales needs trust and costs time.

We solve exactly that: amplifa runs the full outbound process, target identification, personalized first outreach, scheduling, fully automated and tailored to your ideal customers. Clients in machinery and electronics receive on average 8 to 14 qualified new conversations per month.

If this is on your mind, a 30-minute call is enough to see whether we can help.

Best regards,"

---

## EMAIL 9 · MIT · ASIEN-USA · 30D · AUGENHÖHE  (radikale Transparenz)
...
SPRACHREGEL: Die gesamte E-Mail ist IMMER auf ENGLISCH, durchgehend. Anrede 'Dear Mr. {{last_name}},' / 'Dear Ms. {{last_name}},' / 'Hello {{first_name}},'. Schluss 'Best regards,'.
DIE EMAIL SOLL 120-140 WÖRTER HABEN (etwas kürzer als DACH/EU).
...
**CTA (menschlich und konkret, 30-Min digital):** keine "would you maybe"-Formulierung, sondern eine konkrete, selbstbewusste Einladung. Standard: "If this is relevant: would a 30-minute call in the coming weeks work?"
...
I'll admit it openly: I read your LinkedIn profile, skimmed your last three posts and looked at the careers page of Roth Technik, and noticed that sales roles have been posted there continuously for months.

That tells me one thing: the will to grow is there, but the bottleneck is qualified first contact. Hiring more salespeople does not solve the problem when the pipeline they are meant to fill is not yet working systematically. That is exactly when our clients come to us, before paying for a fifth sales salary without seeing more output.
...
## EMAIL 10 · MIT · ASIEN-USA · 30D · AUGENHÖHE  (mutiger Reframe)
...
SPRACHREGEL: Die gesamte E-Mail ist IMMER auf ENGLISCH, durchgehend. Anrede 'Dear Mr. {{last_name}},' / 'Dear Ms. {{last_name}},' / 'Hello {{first_name}},'. Schluss 'Best regards,'.
DIE EMAIL SOLL 135-155 WÖRTER HABEN (etwas kürzer als DACH/EU).
...
**CTA (selbstbewusst, niedriges Commitment, 30-Min digital):** Standard: "No pitch, no pressure, just a 30-minute call to check together whether this is relevant for you."
...
here is an observation that may be uncomfortable: most automation providers of your size grow today almost exclusively through existing customers and referrals, which works until it does not. Winning new customers systematically is a completely different discipline than building excellent technology, and this is where, in 80 percent of cases, the missing piece is not the will but the system.

Companies that took this step report not more effort but less, because qualified meetings arrive automatically instead of being fought for manually.

amplifa runs exactly this stretch for companies like Heitec: from target customer identification to the booked first conversation with the right decision-maker, on average 10 to 14 per month, without burdening your sales team.
