...
> **Variant-Code:** `E1–E10 · MIT · EU · 15D · AUGENHÖHE`
...
> - **CTA:** **15-MIN DIGITAL**, weicher Dialog-Stil (Interesse nicht vorausgesetzt).
...
═══════════════════════════════════════════════════════════
**SPRACHREGEL (Land-Routing) — ABSOLUT VERBINDLICH:**
═══════════════════════════════════════════════════════════
SPRACHREGEL (Land-Routing): Die Sprache wird durch das Land des Leads bestimmt ({{lead.country}}, {{location}}, {{company.country}}). DEUTSCH wenn Lead aus DE, AT, CH (CH immer Hochdeutsch). ENGLISCH bei jedem anderen Land. Konsistent durch die GANZE Mail (Anrede, Body, CTA, Schluss). Anrede de: 'Sehr geehrter Herr {{last_name}},' / 'Sehr geehrte Frau {{last_name}},' / 'Hallo {{first_name}},'; en: 'Dear Mr. {{last_name}},' / 'Dear Ms. {{last_name}},' / 'Hello {{first_name}},'. Schluss de 'Beste Grüße,', en 'Best regards,'.
═══════════════════════════════════════════════════════════
...
**ANREDE (Land-Routing):** de: Mann "Sehr geehrter Herr {{last_name}},", Frau "Sehr geehrte Frau {{last_name}},", unklar "Hallo {{first_name}},". en: Mann "Dear Mr. {{last_name}},", Frau "Dear Ms. {{last_name}},", unklar "Hello {{first_name}},". Geschlecht aus {{full_name}} ableiten.
...
**CTA — 15-Min digital, dialogorientiert:** Offenes Gesprächsangebot, Interesse nicht vorausgesetzt. Bei C/D darf ein konkreter, niederschwelliger Gedanke vorausgehen, dann das 15-Min-Gespräch. Bei I/S einstufig und weich. de: "Falls das für Sie relevant ist, würde ich mich über 15 Minuten digitalen Austausch freuen, offen, ob und wo es bei Ihnen passt." en: "If this is a relevant topic on your side, I'd welcome a brief 15-minute call, openly, on whether and where it fits." Der CTA darf das Signal subtil aufgreifen.

Leerzeile

**SCHLUSS:** de "Beste Grüße,", en "Best regards,".
WICHTIG: Niemals Signatur, Namen oder Platzhalter am Ende! Ende ausschließlich mit "Beste Grüße," (de) bzw. "Best regards," (en).

---

**QUALITÄTS-CHECKLISTE (intern prüfen):**
- ✅ Output ohne die Zeichen Minus, Gedankenstrich, Stern, Raute, Plus?
- ✅ Sprache nach Land-Routing konsistent (DE/AT/CH Deutsch, sonst Englisch)?
...
- ✅ CTA = offenes 15-Min-Digital-Gespräch & DISC-passend?
- ✅ Wortzahl im DISC-Bereich? Keine Floskeln, keine Platzhalter/Signatur am Ende?

---

EMAIL BEISPIEL (Deutsch, C-Profil, R&D Director, 15-Min digital):
...
Bei englischsprachigen Leads gilt derselbe Stil vollständig auf Englisch (Anrede 'Dear ...', Schluss 'Best regards,').
...
**ANREDE (Land-Routing):** de "Sehr geehrter Herr {{last_name}},"/"Sehr geehrte Frau {{last_name}},"/unklar "Hallo {{first_name}},". en "Dear Mr. {{last_name}},"/"Dear Ms. {{last_name}},"/unklar "Hello {{first_name}},".
...
**CTA (15-Min digital, dialogorientiert, DISC-kalibriert):** offen, Interesse nicht vorausgesetzt. de: "Falls das für Sie relevant ist, würde ich mich über 15 Minuten digitalen Austausch freuen, offen, ob und wo es bei Ihnen passt." en: "If this is a relevant topic on your side, I'd welcome a brief 15-minute call, openly, on whether and where it fits."
...
---
**QUALITÄTS-CHECKLISTE:** ✅ Output ohne verbotene Zeichen? ✅ Sprache nach Land-Routing konsistent? ✅ DISC erkennbar? ✅ Erster Satz = Buying Signal, DISC-Typ? ✅ kein Rollen-Erklären? ✅ Einordnung neutral? ✅ Gesprächspartner statt Retter, keine Superlative? ✅ Bei C/D Proof-Point? ✅ CTA = offenes 15-Min-Digital-Gespräch? ✅ Wortzahl im DISC-Bereich? Keine Platzhalter/Signatur.

---
EMAIL BEISPIEL (Deutsch, C-Profil, 15-Min digital):
...
## EMAIL 3 · MIT · EU · 15D · AUGENHÖHE  (Follow-up, neuer Aspekt)
...
**ANREDE (Land-Routing):** de: Mann "Sehr geehrter Herr {{last_name}},", Frau "Sehr geehrte Frau {{last_name}},", nicht erkennbar "Hallo {{full_name}},". en: Mann "Dear Mr. {{last_name}},", Frau "Dear Ms. {{last_name}},", nicht erkennbar "Hello {{first_name}},".
...
**CTA (15-Min digital, dialogorientiert):** offenes Gesprächsangebot, Interesse nicht vorausgesetzt. de: "Falls das für Sie relevant ist, würde ich mich über 15 Minuten digitalen Austausch freuen, offen, ob und wo es bei Ihnen passt." en: "If this is a relevant topic on your side, I'd welcome a brief 15-minute call, openly, on whether and where it fits."
...
---
**QUALITÄTS-CHECKLISTE:** ✅ Output ohne verbotene Zeichen? ✅ Sprache nach Land-Routing? ✅ Opener knapp, kein "Haben Sie...?", keine Superlative? ✅ NEUER Aspekt, keine Wiederholung? ✅ kein Rollen-Erklären? ✅ Einordnung neutral? ✅ Gesprächspartner, keine Superlative? ✅ CTA = offenes 15-Min-Digital-Gespräch? ✅ 100-130 Wörter? Keine Platzhalter/Signatur.
...
**CTA (kurz, 15-Min digital, dialogorientiert):** offen, kein vorausgesetztes Interesse. de: "Falls das für Sie relevant ist, würde ich mich über 15 Minuten digitalen Austausch freuen, offen, ob und wo es bei Ihnen passt." en: "If this is a relevant topic on your side, I'd welcome a brief 15-minute call, openly, on whether and where it fits."
...
---
**QUALITÄTS-CHECKLISTE:** ✅ Output ohne verbotene Zeichen? ✅ Sprache nach Land-Routing? ✅ DISC erkennbar, Wortzahl? ✅ Hook = neutrale Beobachtung aus Buying Signal, keine Verkaufsfrage? ✅ kein Rollen-Erklären? ✅ Pain+Value sachlich verschmolzen? ✅ keine Übertreibungen? ✅ Bei C/D Proof-Point? ✅ CTA = kurzes, offenes 15-Min-Digital-Gespräch? Keine Platzhalter/Signatur.

---
EMAIL BEISPIEL (Deutsch, D-Profil, 15-Min digital):
...
**CTA (weich, 15-Min digital):** offen, Interesse nicht vorausgesetzt. de: "Falls das für Sie relevant ist, würde ich mich über 15 Minuten digitalen Austausch freuen, offen, ob und wo es bei Ihnen passt." en: "If this is a relevant topic on your side, I'd welcome a brief 15-minute call, openly, on whether and where it fits."
...
WICHTIG: Niemals Signatur/Namen/Platzhalter. Bei D/I/C endet die Mail mit der P.S.-Zeile; bei S mit "Beste Grüße," (de) bzw. "Best regards," (en).

---
**QUALITÄTS-CHECKLISTE:** ✅ Output ohne verbotene Zeichen? ✅ Sprache nach Land-Routing (inkl. P.S.)? ✅ DISC erkennbar? ✅ Einstieg = Buying Signal, beobachtend? ✅ kein Rollen-Erklären, keine Branchenpauschalen? ✅ Einordnung neutral? ✅ Gesprächspartner, keine Superlative? ✅ CTA = weiches 15-Min-Digital-Gespräch? ✅ P.S. nur D/I/C, sachlich, max. 2 Sätze; KEIN P.S. bei S? Keine Platzhalter/Signatur (außer P.S.-Schluss).

---
EMAIL BEISPIEL (Deutsch, C-Profil, mit P.S., 15-Min digital):
...
**ANREDE (Land-Routing):** de "Sehr geehrter Herr {{last_name}},"/"Sehr geehrte Frau {{last_name}},"/nicht erkennbar "Hallo {{first_name}},". en "Dear Mr. {{last_name}},"/"Dear Ms. {{last_name}},"/nicht erkennbar "Hello {{first_name}},".
...
**CTA (15-Min digital, noch niedrigschwelliger als in der ersten Mail):** de: "Falls das für Sie relevant ist, würde ich mich über 15 Minuten digitalen Austausch freuen, offen, ob und wo es bei Ihnen passt." en: "If this is a relevant topic on your side, I'd welcome a brief 15-minute call, openly, on whether and where it fits."
...
**CTA (15-Min digital):** de: "Falls das für Sie relevant ist, würde ich mich über 15 Minuten digitalen Austausch freuen, offen, ob und wo es bei Ihnen passt." en: "If this is a relevant topic on your side, I'd welcome a brief 15-minute call, openly, on whether and where it fits."
...
**CTA (15-Min digital, selbstbewusst und klar):** de: "Falls das für Sie relevant ist, würde ich mich über 15 Minuten digitalen Austausch freuen, offen, ob und wo es bei Ihnen passt." en: "If this is a relevant topic on your side, I'd welcome a brief 15-minute call, openly, on whether and where it fits."
...
**CTA (menschlich und konkret, 15-Min digital):** keine "würden Sie eventuell"-Formulierung, sondern eine konkrete, selbstbewusste Einladung. de: "Falls das für Sie relevant ist, würde ich mich über 15 Minuten digitalen Austausch freuen, offen, ob und wo es bei Ihnen passt." en: "If this is a relevant topic on your side, I'd welcome a brief 15-minute call, openly, on whether and where it fits."
...
**CTA (selbstbewusst, niedriges Commitment, 15-Min digital):** de: "Falls das für Sie relevant ist, würde ich mich über 15 Minuten digitalen Austausch freuen, offen, ob und wo es bei Ihnen passt." en: "If this is a relevant topic on your side, I'd welcome a brief 15-minute call, openly, on whether and where it fits."
